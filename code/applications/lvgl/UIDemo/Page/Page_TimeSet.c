 ...
 * 初始化按钮样式
 * 
 * 本函数用于初始化一个预定义的按钮样式，包括圆角、边框宽度、边框颜色、背景颜色和文本颜色等。
 * 这些样式设置确保了按钮在用户界面中有一致和预期的外观。
 */
